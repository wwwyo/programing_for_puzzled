...
def hanoi4pegs(numRings, startPeg, middlePeg, endPeg, fourthPeg):
    ...
    numMoves = 0
    if numRings > 0:
        numMoves += hanoiOffset(numRings//2 // 2, 0, startPeg, middlePeg, endPeg)
        numMoves += hanoiOffset(numRings//2 // 2, numRings//2//2, startPeg, middlePeg, fourthPeg)
        numMoves += hanoiOffset(numRings//2 //2, 0, endPeg, middlePeg, fourthPeg)
        numMoves += hanoiOffset(numRings//2, numRings//2, startPeg, middlePeg, endPeg)
        numMoves += hanoiOffset(numRings//2 // 2, 0, fourthPeg, middlePeg, startPeg)
        numMoves += hanoiOffset(numRings//2 // 2, numRings //2 //2 , fourthPeg, middlePeg, endPeg)
        numMoves += hanoiOffset(numRings//2 // 2, 0, startPeg, middlePeg, endPeg)
